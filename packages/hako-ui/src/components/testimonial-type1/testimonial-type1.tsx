...
export interface TestimonialType1Props extends HTMLAttributes<HTMLDivElement> {
  /**
   ...
   * @type {Testimonial[]}
   * @example [{ avatarUrl: 'https://www.google.com/image.png', name: 'Sarah Connor', designation: 'CEO at Skynet Resistance Ltd', message: 'Hako UI is the best UI kit I have ever used. I love it!' }]
   * @default []
   */
 ...
 */
export const TestimonialType1 = forwardRef<HTMLDivElement, TestimonialType1Props>(
...
TestimonialType1.displayName = 'TestimonialType1';
